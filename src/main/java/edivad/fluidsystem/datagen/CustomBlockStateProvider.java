...
public abstract class CustomBlockStateProvider extends BlockStateProvider {
    ...
    public CustomBlockStateProvider(PackOutput packOutput, String modId, ExistingFileHelper exFileHelper) {
    ...
    protected void pipeBuilder(PipeBlock pipe) {
        ...
        ModelFile pipeStraight = pipeStraight("pipe_straight", modLoc(ModelProvider.BLOCK_FOLDER + "/pipe"));
