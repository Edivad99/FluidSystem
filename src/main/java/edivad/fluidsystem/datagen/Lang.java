...
public class Lang extends LanguageProvider {
  ...
  public Lang(PackOutput packOutput) {
    super(packOutput, FluidSystem.ID, "en_us");
  }
  ...
  protected void addTranslations() {
    ...
    add(Translations.TANKS_BLOCK, "Tank's block: %s");
    ...
    add(Translations.TANK_BLOCK_INTERFACE_TOOLTIP,
        "Block that allows you to withdraw and insert liquids into the tank");
    add(Translations.TANK_BLOCK_CONTROLLER_TOOLTIP, "Main block that allows you to form the tank");
    add(Translations.TANK_BLOCK_INPUT_TOOLTIP,
        "Block that allows the insertion of liquids through our pipes");
    add(Translations.INPUT_PIPE_TOOLTIP,
        "Block that allows you to put liquid in the pipes, with a redstone signal");
    add(Translations.OUTPUT_PIPE_TOOLTIP,
        "Block that allows you to take the liquid from the pipes");
    ...
    add(Translations.JADE_ENABLE_FILTERABLE_BLOCK,
        "Enable custom visualization for filterable blocks");
  }
